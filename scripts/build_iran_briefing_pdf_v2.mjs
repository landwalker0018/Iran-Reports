...
const htmlPath = path.join(outDir, "iran-briefing-2026-05-30_2100-v2.html");
const pdfPath = path.join(outDir, "iran-briefing-2026-05-30_2100-v2.pdf");
const shotPath = path.join(outDir, "iran-briefing-2026-05-30_2100-v2-preview.png");
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .meta small { display:block; color:#f2c5a5; font-size: 9px; margin-bottom: 5px; }
  .meta b { font-size: 13px; font-weight: 650; }
  .titlebar {
    display: flex;
    justify-content: space-between;
  ...
  .grid-3 { display: grid; grid-template-columns: 1.05fr 1fr 1fr; gap: 11px; }
  ...
  .bar-row {
    display: grid;
    grid-template-columns: 34mm 1fr 14mm;
    align-items: center;
    gap: 8px;
    margin: 6px 0;
    font-size: 11px;
  ...
  .event .time { color:#8a7a6c; font-size: 10px; }
  ...
  .watch .card { min-height: 34mm; }
  .small { font-size: 10.3px; line-height: 1.45; color:#3c3c3c; }
  .muted { color: #71685f; }
  .source-list {
    columns: 2;
    column-gap: 16px;
...
<body>
  ...
  <section class="page">
    ...
    <div class="deck"><span>Iran Briefing V2</span><span>1 / 5</span></div>
  </section>
  ...
  <section class="page">
    ...
    <div class="deck"><span>Iran Briefing V2</span><span>2 / 5</span></div>
  </section>
  ...
  <section class="page">
    ...
    <div class="deck"><span>Iran Briefing V2</span><span>3 / 5</span></div>
  </section>
  ...
  <section class="page">
    ...
    <div class="deck"><span>Iran Briefing V2</span><span>4 / 5</span></div>
  </section>
  ...
  <section class="page">
    ...
    <div class="deck"><span>Iran Briefing V2</span><span>5 / 5</span></div>
  </section>
</body>
</html>`;
